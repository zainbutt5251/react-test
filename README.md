...
△ Task 1 
- Display Login/Register page before the landing page (Done)
- Users are should to login first to access the full list of tabs. (Done)
- When they're logged out, only Dashboard panel should to be displayed.(not understandable)

△ Task 2 - Task Filter 
- Allow users to filter tasks based on their completion status (e.g., show only completed or incomplete tasks). (Done)
- Optional: Add a search feature to filter tasks by title. (Done)
